...
export const teelish = '#08866A';
export const marvelGreen = ' #00A87D';
export const cGreen = '#73b5a4';
export const dullishGreen = '#024231';
export const marvelGreenDull = '#01785a';
...
export const highlightGreenDull = '#F0F9F6';
export const darkBlue = '#203541';
export const darkGrey = '#26292d';
export const smokeGrey = '#818A88';
export const ashWhite = '#C0C7C5';
export const lightAshWhite = '#E1E1E1';
export const vulcanGrey = '#373A40';
export const black80 = 'rgba(0,0,0,0.80)';
export const matBlack = '#00231B';
export const marvelGreen25 = `rgb(8 134 106 / 25%)`;
...
export const headerHeightMb = 50;
